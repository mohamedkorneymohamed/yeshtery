              ...
              <div className="row">
                <div className="col-md-6 text-center text-md-start">
                  <div className="desc">
                    <div className="yeshtery-footer__logo pb-2">
                      <img src={process.env.PUBLIC_URL +"/images/brand-logo-yellow.svg"} />
                    </div>
                      ...
                      <div className="col-6">
                        <ul className="yeshtery-social text-center">
                          <li className="social-link">
                            {" "}
                            <img src={process.env.PUBLIC_URL +"/images/facebook@2x.png" }width={30} />
                            <span className="ps-2">/YESHTERY</span>
                          </li>
                          <li className="social-link">
                            {" "}
                            <img src={process.env.PUBLIC_URL +"/images/instagram@2x.png"} width={30} />
                            <span className="ps-2">/YESHTERY</span>
                          </li>
                          <li className="social-link">
                            {" "}
                            <img src={process.env.PUBLIC_URL +"/images/linkedin@2x.png"} width={30} />
                            <span className="ps-2">/YESHTERY</span>
                          </li>
                          <li className="social-link">
                            {" "}
                            <img src={process.env.PUBLIC_URL +"/images/twitter.png"} width={35} />
                            <span className="ps-2">/YESHTERY</span>
                          </li>
                        </ul>
                      </div>
                ...
                <div className="copy-right d-flex justify-content-between align-items-center flex-nowrap py-3">
                  ...
                  <div className="cash-online">
                    <img src={process.env.PUBLIC_URL +"/images/cash.png"} className="mx-1" width={30} />
                    <img src={process.env.PUBLIC_URL +"/images/visa.png"} className="mx-1" width={30} />
                    <img
                      src={process.env.PUBLIC_URL +"/images/matercard.png"}
                      className="mx-1"
                      width={30}
                    />
                  </div>
                  <span>
                    Powered By <img src={process.env.PUBLIC_URL +"/images/nas_nav.svg"} width={80} />
                  </span>
                </div>
              </div>
            </div>
